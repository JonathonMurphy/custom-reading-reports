...
module.exports.ClassObject = class CustomReportClassObject {
  constructor(classOfGetClassDataRes) {
    this.inst = getClassDataRes.institution_name;
    this.className = getClassDataRes.name;
    this.classID = getClassDataRes.classe_uid;
    this.primaryTeacher = `${getClassDataRes.official_staff.first_name} ${getClassDataRes.official_staff.last_name}`;
    this.students = [];
  }
};

// Accepts the Class State Aqua Res as an argument
module.exports.StudentObject =  class CustomReportStudentObject {
  constructor(studentOfGetClassStateRes) {
    this.fullName = getClassStateRes.FullName;
    this.aquaID = getClassStateRes.UserId;
    this.gradeLevel = getClassStateRes.GradeLevel;
    this.timePlayed = undefined;
  }
};

// Accepts the previous two objects as it's arguments
